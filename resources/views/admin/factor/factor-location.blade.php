           ...
           <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
              <tr role="row">
                ...
                <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 140.7px;" aria-sort="ascending" aria-label="نام محصول: activate to sort column descending">نام کاربر</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 73.35px;" aria-label="دسته‌بندی: activate to sort column ascending">مبلغ خرید</th>
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 269.483px;" aria-label="توضیحات: activate to sort column ascending">روش پرداخت</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 258.683px;" aria-label="قیمت: activate to sort column ascending">آدرس تحویل</th>
            ...
            <tbody>
              <?php foreach ($factors as $factor): ?>
                <tr role="row" class="odd">
                  ...
                  <td class="sorting_1">{{$factor->user->name}}</td>
                  <td>{{$factor->sum}}</td>
                  {{-- <td>{{$product->producer->name}}</td> --}}
                  <td>{{$factor->status}}</td>
                  <td>{{$factor->payment_method}}</td>
                  <td>{{$factor->address->address ?? ''}}</td>
